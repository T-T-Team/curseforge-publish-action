...
var CHANGELOG_TEXT = "text";
var CHANGELOG_HTML = "html";
var CHANGELOG_MARKDOWN = "markdown";
var CHANGELOG_TYPES = [
  CHANGELOG_TEXT,
  CHANGELOG_HTML,
  CHANGELOG_MARKDOWN
];
var CHANNEL_RELEASE = "release";
var CHANNEL_BETA = "beta";
var CHANNEL_ALPHA = "alpha";
var RECOGNIZE_CHANNEL_LIST = [
  CHANNEL_ALPHA,
  CHANNEL_BETA
];
var CHANNEL_TYPES = [
  CHANNEL_RELEASE,
  ...RECOGNIZE_CHANNEL_LIST
];
var RELATION_REQUIRED = "requiredDependency";
var RELATION_OPTIONAL = "optionalDependency";
...
async function loadGameVersionList(artifact) {
  ...
  for (const version of artifact.versionNames) {
    ...
    const matchedVersion = versionList.find((v) => v.slug === value.toLowerCase());
    if (!matchedVersion) {
...
main().catch((e) => actions.setFailed(e.message));
